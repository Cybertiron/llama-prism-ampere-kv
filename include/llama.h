...
extern "C" {
    ...
    // KVarN: Huawei's calibration-free variance-normalized KV-cache quantizer
    // (arXiv 2606.03458). Structured per-128-token-tile K/V records with
    // independent key/value bit widths. Selected via a separate params object.
